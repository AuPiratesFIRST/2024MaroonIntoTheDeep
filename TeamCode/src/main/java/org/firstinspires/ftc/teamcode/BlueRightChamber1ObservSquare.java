...
@Config
@Autonomous(name = "BlueRightChamber1ObservSquare", group = "Autonomous")
public class BlueRightChamber1ObservSquare extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(-34, 0, Math.toRadians(0)))
                ...
                .splineToConstantHeading(new Vector2d(-60, -55), Math.toRadians(180));
