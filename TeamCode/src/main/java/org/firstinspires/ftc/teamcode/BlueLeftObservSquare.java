...
@Config
@Autonomous(name = "BlueLeftObservSquare", group = "Autonomous")
public class BlueLeftObservSquare extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .splineToConstantHeading(new Vector2d(-25, 0), Math.toRadians(270))
