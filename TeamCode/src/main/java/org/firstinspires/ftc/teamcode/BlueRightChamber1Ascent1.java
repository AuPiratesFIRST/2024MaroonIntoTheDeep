...
@Config
@Autonomous(name = "BlueRightChamber1Ascent1", group = "Autonomous")
public class BlueRightChamber1Ascent1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(-34, 0, Math.toRadians(0)))
