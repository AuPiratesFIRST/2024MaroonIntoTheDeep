...
@Config
@Autonomous(name = "BlueRightNetHigh1ObservTri", group = "Autonomous")
public class BlueRightNetHigh1ObservTri extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(-52, 53, Math.toRadians(137)))
                ...
                .splineToLinearHeading(new Pose2d(-60, -38, Math.toRadians(0)), Math.PI);
