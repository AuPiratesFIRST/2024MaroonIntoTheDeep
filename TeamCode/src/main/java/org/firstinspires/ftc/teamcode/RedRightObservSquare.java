...
@Config
@Autonomous(name = "RedRightObservSquare", group = "Autonomous")
public class RedRightObservSquare extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .splineToConstantHeading(new Vector2d(38, 0), Math.toRadians(270))
                .setTangent(Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(38, -50), Math.toRadians(270))
                .setTangent(Math.toRadians(270))
