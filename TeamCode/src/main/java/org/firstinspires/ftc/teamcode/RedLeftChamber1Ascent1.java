...
@Config
@Autonomous(name = "RedLeftChamber1Ascent1", group = "Autonomous")
public class RedLeftChamber1Ascent1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                .setTangent(180)
                .splineToConstantHeading(new Vector2d(33, 0), 180);

        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(33, 0, Math.toRadians(180)))
