...
@Config
@Autonomous(name = "BlueRightChamber1ObservTri", group = "Autonomous")
public class BlueRightChamber1ObservTri extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(-34, 0, Math.toRadians(0)))
                ...
                .splineToConstantHeading(new Vector2d(-60, -38), Math.toRadians(180));
