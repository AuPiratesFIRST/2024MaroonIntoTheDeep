...
@Config
@Autonomous(name = "BlueRightAscent1", group = "Autonomous")
public class BlueRightAscent1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(-34, 27, Math.toRadians(270)), Math.toRadians(90))
