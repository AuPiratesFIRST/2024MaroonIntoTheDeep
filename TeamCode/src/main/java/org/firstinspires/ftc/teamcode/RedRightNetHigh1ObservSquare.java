...
@Config
@Autonomous(name = "RedRightNetHigh1ObservSquare", group = "Autonomous")
public class RedRightNetHigh1ObservSquare extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(52, 53, Math.toRadians(45)), Math.toRadians(180));
