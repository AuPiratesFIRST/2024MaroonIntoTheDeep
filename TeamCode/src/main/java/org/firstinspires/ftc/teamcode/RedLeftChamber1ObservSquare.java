...
@Config
@Autonomous(name = "RedLeftChamber1ObservSquare", group = "Autonomous")
public class RedLeftChamber1ObservSquare extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .splineToConstantHeading(new Vector2d(-38, 0),180 );

        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(-38, 0, Math.toRadians(180)))
