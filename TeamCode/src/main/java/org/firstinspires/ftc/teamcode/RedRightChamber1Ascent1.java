...
@Config
@Autonomous(name = "RedRightChamber1Ascent1", group = "Autonomous")
public class RedRightChamber1Ascent1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(33, 0, Math.toRadians(0)))
