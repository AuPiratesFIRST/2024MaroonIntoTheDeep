...
@Config
@Autonomous(name = "RedRightNetHigh1Ascent1", group = "Autonomous")
public class RedRightNetHigh1Ascent1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(52, 53, Math.toRadians(45)), Math.PI);

        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(52, 53, Math.toRadians(45)))
                .setTangent(Math.toRadians(180))
                .splineToLinearHeading(new Pose2d(34, 52, Math.toRadians(90)), Math.toRadians(270))
                .lineToY(-34)
