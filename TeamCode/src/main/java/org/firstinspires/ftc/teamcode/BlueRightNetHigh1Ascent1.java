...
@Config
@Autonomous(name = "BlueRightNetHigh1Ascent1", group = "Autonomous")
public class BlueRightNetHigh1Ascent1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(-52, 53, Math.toRadians(137)))
                ...
                .splineToLinearHeading(new Pose2d(0, 19, Math.toRadians(270)), Math.toRadians(270));
